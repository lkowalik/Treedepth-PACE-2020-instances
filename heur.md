...
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
100 | 340 | 2.0 | generated | Python networkx package | expander-margulis_100.gr | 
...
![](vis/heur_002.png?raw=true)
## heur_003.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
105 | 312 | 1.8 | planted | PACE 2020 | planted_weighted_cycle_23_4+46v+46e.gr | 
...
![](vis/heur_006.png?raw=true)
## heur_007.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
114 | 143 | 0.9 | infrastracture | Open street maps | Oleszno_Poland.gr | 

**Description:** Oleszno (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_007.png?raw=true)
## heur_008.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_009.png?raw=true)
## heur_010.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
120 | 479 | 2.9 | planted | PACE 2020 | planted_rand_tree_120+360e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_010.png?raw=true)
## heur_011.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_012.png?raw=true)
## heur_013.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
138 | 493 | 3.2 | social | Stanford Graph Base | anna.gr | 

**Description:** Anna Karenina graph from  Stanford Graph Base

![](vis/heur_013.png?raw=true)
## heur_014.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_016.png?raw=true)
## heur_017.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
150 | 598 | 3.8 | planted | PACE 2020 | planted_weighted_cycle_27_5+54v+54e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_017.png?raw=true)
## heur_018.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_018.png?raw=true)
## heur_019.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
170 | 339 | 2.3 | planted | PACE 2020 | planted_rand_tree_170+170e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_019.png?raw=true)
## heur_020.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_023.png?raw=true)
## heur_024.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
211 | 313 | 2.2 | generated | Python networkx package | expander-chordal-cycle_211.gr | 
...
![](vis/heur_024.png?raw=true)
## heur_025.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
212 | 257 | 1.8 | infrastracture | Open street maps | Mielnik_Poland.gr | 

**Description:** Mielnik (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_025.png?raw=true)
## heur_026.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
220 | 298 | 2.1 | infrastracture | Open street maps | Unieście_Poland.gr | 

**Description:** Unieście (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_026.png?raw=true)
## heur_027.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
225 | 771 | 5.3 | planted | PACE 2020 | planted_weighted_cycle_45_5+90v+90e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_027.png?raw=true)
## heur_028.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_036.png?raw=true)
## heur_037.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
300 | 450 | 3.2 | generated | Python networkx package | random-cubic_300.gr | 

**Description:** A random cubic graph generated using random_regular_graph function from Python’s networkx package

![](vis/heur_037.png?raw=true)
## heur_038.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_038.png?raw=true)
## heur_039.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
300 | 1199 | 8.5 | planted | PACE 2020 | planted_rand_tree_300+900e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_039.png?raw=true)
## heur_040.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_046.png?raw=true)
## heur_047.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
441 | 1638 | 12.1 | generated | Python networkx package | expander-margulis_441.gr | 

**Description:** A  Margulis-Gabber-Galil undirected graph (8-regular expander with multiple edges removed) on n^2 nodes. Generated using margulis_gabber_galil_graph from Python’s networkx package

![](vis/heur_047.png?raw=true)
## heur_048.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_051.png?raw=true)
## heur_052.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
498 | 702 | 5.3 | infrastracture | Open street maps | Terespol_Poland.gr | 

**Description:** Terespol (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_052.png?raw=true)
## heur_053.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_059.png?raw=true)
## heur_060.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
675 | 2699 | 20.3 | planted | PACE 2020 | planted_rand_tree_675+2025e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_060.png?raw=true)
## heur_061.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
711 | 3917 | 29.5 | planted | PACE 2020 | planted_weighted_cycle_112_8+224v+448e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_061.png?raw=true)
## heur_062.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_067.png?raw=true)
## heur_068.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
1012 | 4047 | 31.0 | planted | PACE 2020 | planted_rand_tree_1012+3036e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_068.png?raw=true)
## heur_069.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
1013 | 1518 | 11.7 | generated | Python networkx package | expander-chordal-cycle_1013.gr | 

**Description:** A cycle graph on p nodes with chords joining each vertex x to its inverse modulo p. This graph is a (mildly explicit) 3-regular expander. Generated using chordal_cycle_graph function from Python’s networkx package

![](vis/heur_069.png?raw=true)
## heur_070.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
1016 | 1462 | 11.2 | infrastracture | Open street maps | Turzyn_Poland.gr | 

**Description:** Turzyn (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_070.png?raw=true)
## heur_071.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_074.png?raw=true)
## heur_075.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
1215 | 7995 | 63.9 | planted | PACE 2020 | planted_weighted_cycle_168_9+336v+756e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_075.png?raw=true)
## heur_076.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_083.png?raw=true)
## heur_084.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
2037 | 3057 | 26.7 | infrastracture | Open street maps | Gocław_Poland.gr | 

**Description:** Gocław (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_084.png?raw=true)
## heur_085.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_085.png?raw=true)
## heur_086.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
2209 | 8554 | 75.3 | generated | Python networkx package | expander-margulis_2209.gr | 

**Description:** A  Margulis-Gabber-Galil undirected graph (8-regular expander with multiple edges removed) on n^2 nodes. Generated using margulis_gabber_galil_graph from Python’s networkx package

![](vis/heur_086.png?raw=true)
## heur_087.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
2278 | 9111 | 79.1 | planted | PACE 2020 | planted_rand_tree_2278+6834e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_087.png?raw=true)
## heur_088.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_091.png?raw=true)
## heur_092.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
3096 | 25220 | 228.7 | planted | PACE 2020 | planted_weighted_cycle_379_11+758v+2084e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_092.png?raw=true)
## heur_093.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_094.png?raw=true)
## heur_095.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
3417 | 13667 | 125.3 | planted | PACE 2020 | planted_rand_tree_3417+10251e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_095.png?raw=true)
## heur_096.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_109.png?raw=true)
## heur_110.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
6921 | 9710 | 91.9 | infrastracture | Open street maps | Włocławek_Poland.gr | 

**Description:** Włocławek (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_110.png?raw=true)
## heur_111.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_114.png?raw=true)
## heur_115.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
7577 | 70754 | 670.8 | planted | PACE 2020 | planted_weighted_cycle_854_13+1708v+5551e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_115.png?raw=true)
## heur_116.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_116.png?raw=true)
## heur_117.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
7688 | 30751 | 292.9 | planted | PACE 2020 | planted_rand_tree_7688+23064e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_117.png?raw=true)
## heur_118.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_122.png?raw=true)
## heur_123.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
10416 | 15534 | 149.8 | infrastracture | Open street maps | Grudziądz_Poland.gr | 

**Description:** Grudziądz (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_123.png?raw=true)
## heur_124.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_124.png?raw=true)
## heur_125.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
10828 | 15597 | 151.6 | infrastracture | Open street maps | Bemowo_Warszawa_Poland.gr | 

**Description:** Bemowo (Warszawa_Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_125.png?raw=true)
## heur_126.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
11449 | 22684 | 223.0 | generated | Python networkx package | grid_11449.gr | 

**Description:** A grid graph generated using grid_graph function from Python’s networkx package

![](vis/heur_126.png?raw=true)
## heur_127.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
11533 | 46131 | 453.4 | planted | PACE 2020 | planted_rand_tree_11533+34599e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_127.png?raw=true)
## heur_128.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
12049 | 122284 | 1212.7 | planted | PACE 2020 | planted_weighted_cycle_1281_14+2562v+8967e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_128.png?raw=true)
## heur_129.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_133.png?raw=true)
## heur_134.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
16888 | 25278 | 263.8 | infrastracture | Open street maps | Toruń_Poland.gr | 

**Description:** Toruń (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_134.png?raw=true)
## heur_135.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
17299 | 69195 | 726.2 | planted | PACE 2020 | planted_rand_tree_17299+51897e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_135.png?raw=true)
## heur_136.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_136.png?raw=true)
## heur_137.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
19539 | 220907 | 2345.3 | planted | PACE 2020 | planted_weighted_cycle_1922_15+3844v+14415e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_137.png?raw=true)
## heur_138.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_140.png?raw=true)
## heur_141.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
23907 | 58424 | 632.0 | generated | Python networkx package | waxman_23907.gr | 

**Description:** A Waxman graph (a random geometric graph) generated using waxman_graph function from Python’s networkx package

![](vis/heur_141.png?raw=true)
## heur_142.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
25670 | 37692 | 409.9 | infrastracture | Open street maps | Reykjavik_Iceland.gr | 

**Description:** Reykjavik (Iceland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_142.png?raw=true)
## heur_143.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
25949 | 103795 | 1124.7 | planted | PACE 2020 | planted_rand_tree_25949+77847e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_143.png?raw=true)
## heur_144.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_144.png?raw=true)
## heur_145.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
30136 | 355825 | 3913.8 | planted | PACE 2020 | planted_weighted_cycle_2883_16+5766v+23064e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_145.png?raw=true)
## heur_146.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_146.png?raw=true)
## heur_147.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
33145 | 48326 | 534.7 | infrastracture | Open street maps | Białystok_Poland.gr | 

**Description:** Białystok (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_147.png?raw=true)
## heur_148.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
33694 | 37947 | 420.2 | infrastracture | Open street maps | osm-primary-roads-Poland.gr | 

**Description:** Poland (primary roads): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_148.png?raw=true)
## heur_149.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
33836 | 47707 | 528.3 | infrastracture | Open street maps | Katowice_Poland.gr | 

**Description:** Katowice (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_149.png?raw=true)
## heur_150.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
38923 | 155691 | 1743.9 | planted | PACE 2020 | planted_rand_tree_38923+116769e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_150.png?raw=true)
## heur_151.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_151.png?raw=true)
## heur_152.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
40693 | 61038 | 682.8 | generated | Python networkx package | expander-chordal-cycle_40693.gr | 

**Description:** A cycle graph on p nodes with chords joining each vertex x to its inverse modulo p. This graph is a (mildly explicit) 3-regular expander. Generated using chordal_cycle_graph function from Python’s networkx package

![](vis/heur_152.png?raw=true)
## heur_153.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
44321 | 63594 | 713.9 | infrastracture | Open street maps | Szczecin_Poland.gr | 

**Description:** Szczecin (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_153.png?raw=true)
## heur_154.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
44535 | 69221 | 777.6 | infrastracture | Open street maps | Amsterdam_Netherlands.gr | 

**Description:** Amsterdam (Netherlands): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_154.png?raw=true)
## heur_155.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
45455 | 64428 | 724.4 | infrastracture | Open street maps | Bucharest_Romania.gr | 

**Description:** Bucharest (Romania): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_155.png?raw=true)
## heur_156.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_156.png?raw=true)
## heur_157.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
47463 | 601759 | 6776.2 | planted | PACE 2020 | planted_weighted_cycle_4324_17+8648v+36754e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_157.png?raw=true)
## heur_158.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_158.png?raw=true)
## heur_159.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
48050 | 69027 | 777.6 | infrastracture | Open street maps | Gdańsk_Poland.gr | 

**Description:** Gdańsk (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_159.png?raw=true)
## heur_160.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
51906 | 70100 | 792.4 | infrastracture | Open street maps | Vilnius_Lithuania.gr | 

**Description:** Vilnius (Lithuania): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_160.png?raw=true)
## heur_161.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
58385 | 233539 | 2649.0 | planted | PACE 2020 | planted_rand_tree_58385+175155e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_161.png?raw=true)
## heur_162.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
60411 | 88589 | 1006.5 | infrastracture | Open street maps | Stockholm_Sweden.gr | 

**Description:** Stockholm (Sweden): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_162.png?raw=true)
## heur_163.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
60924 | 87941 | 999.4 | infrastracture | Open street maps | Poznań_Poland.gr | 

**Description:** Poznań (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_163.png?raw=true)
## heur_164.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
61125 | 85496 | 971.4 | infrastracture | Open street maps | Bratislava_Slovakia.gr | 

**Description:** Bratislava (Slovakia): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_164.png?raw=true)
## heur_165.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
69761 | 89649 | 1022.4 | infrastracture | Open street maps | Belgrade_Serbia.gr | 

**Description:** Belgrade (Serbia): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_165.png?raw=true)
## heur_166.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
74512 | 1003437 | 11468.1 | planted | PACE 2020 | planted_weighted_cycle_6487_18+12974v+58383e.gr | 

**Description:** A cycle of cliques of random cycles with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_166.png?raw=true)
## heur_167.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
84260 | 114967 | 1317.9 | infrastracture | Open street maps | Oslo_Norway.gr | 

**Description:** Oslo (Norway): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_167.png?raw=true)
## heur_168.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
87578 | 350311 | 4018.1 | planted | PACE 2020 | planted_rand_tree_87578+262734e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_168.png?raw=true)
## heur_169.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
87702 | 125808 | 1443.7 | infrastracture | Open street maps | Wrocław_Poland.gr | 

**Description:** Wrocław (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_169.png?raw=true)
## heur_170.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
93413 | 135176 | 1553.0 | infrastracture | Open street maps | Budapest_Hungary.gr | 

**Description:** Budapest (Hungary): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_170.png?raw=true)
## heur_171.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
94769 | 121465 | 1395.7 | infrastracture | Open street maps | Cyprus.gr | 

**Description:** Cyprus: a road network downloaded from open street maps using osmnx python package

![](vis/heur_171.png?raw=true)
## heur_172.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
100924 | 143077 | 1648.2 | infrastracture | Open street maps | Łodzia_Poland.gr | 

**Description:** Łodzia (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_172.png?raw=true)
## heur_173.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
107366 | 156183 | 1819.5 | infrastracture | Open street maps | Ankara_Turkey.gr | 

**Description:** Ankara (Turkey): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_173.png?raw=true)
## heur_174.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
112777 | 163132 | 1916.2 | infrastracture | Open street maps | Kyiv_Ukraine.gr | 

**Description:** Kyiv (Ukraine): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_174.png?raw=true)
## heur_175.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
117297 | 149604 | 1768.4 | infrastracture | Open street maps | Dublin_Ireland.gr | 

**Description:** Dublin (Ireland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_175.png?raw=true)
## heur_176.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
117456 | 176184 | 2083.3 | generated | Python networkx package | random-cubic_117456.gr | 

**Description:** A random cubic graph generated using random_regular_graph function from Python’s networkx package

![](vis/heur_176.png?raw=true)
## heur_177.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_177.png?raw=true)
## heur_178.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
131368 | 525471 | 6326.7 | planted | PACE 2020 | planted_rand_tree_131368+394104e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_178.png?raw=true)
## heur_179.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
153813 | 227178 | 2784.5 | infrastracture | Open street maps | Warszawa_Poland.gr | 

**Description:** Warszawa (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_179.png?raw=true)
## heur_180.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
197052 | 788207 | 9943.6 | planted | PACE 2020 | planted_rand_tree_197052+591156e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_180.png?raw=true)
## heur_181.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
199674 | 299511 | 3769.4 | generated | Python networkx package | random-cubic_199674.gr | 

**Description:** A random cubic graph generated using random_regular_graph function from Python’s networkx package

![](vis/heur_181.png?raw=true)
## heur_182.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
201693 | 260616 | 3282.3 | infrastracture | Open street maps | Rome_Italy.gr | 

**Description:** Rome (Italy): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_182.png?raw=true)
## heur_183.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
205957 | 287541 | 3627.7 | infrastracture | Open street maps | Berlin_Germany.gr | 

**Description:** Berlin (Germany): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_183.png?raw=true)
## heur_184.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
206512 | 265805 | 3355.0 | infrastracture | Open street maps | Bern_Switzerland.gr | 

**Description:** Bern (Switzerland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_184.png?raw=true)
## heur_185.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_186.png?raw=true)
## heur_187.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
295578 | 1182311 | 15158.3 | planted | PACE 2020 | planted_rand_tree_295578+886734e.gr | 

**Description:** A random tree with some added random edges that go bottom-up the optimal treedepth decomposition

![](vis/heur_187.png?raw=true)
## heur_188.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_188.png?raw=true)
## heur_189.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
332392 | 482769 | 6285.3 | infrastracture | Open street maps | Madrid_Spain.gr | 

**Description:** Madrid (Spain): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_189.png?raw=true)
## heur_190.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
332476 | 437371 | 5692.5 | infrastracture | Open street maps | London_UnitedKingdom.gr | 

**Description:** London (UnitedKingdom): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_190.png?raw=true)
## heur_191.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
...
![](vis/heur_191.png?raw=true)
## heur_192.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
406024 | 589547 | 7744.2 | infrastracture | Open street maps | Moscow_Russia.gr | 

**Description:** Moscow (Russia): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_192.png?raw=true)
## heur_193.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
442225 | 883120 | 11642.3 | generated | Python networkx package | grid_442225.gr | 

**Description:** A grid graph generated using grid_graph function from Python’s networkx package

![](vis/heur_193.png?raw=true)
## heur_194.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
442225 | 1764910 | 23266.1 | generated | Python networkx package | expander-margulis_442225.gr | 

**Description:** A  Margulis-Gabber-Galil undirected graph (8-regular expander with multiple edges removed) on n^2 nodes. Generated using margulis_gabber_galil_graph from Python’s networkx package

![](vis/heur_194.png?raw=true)
## heur_195.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
443366 | 665049 | 8767.0 | generated | Python networkx package | random-cubic_443366.gr | 

**Description:** A random cubic graph generated using random_regular_graph function from Python’s networkx package

![](vis/heur_195.png?raw=true)
## heur_196.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
443369 | 665050 | 8767.1 | generated | Python networkx package | expander-chordal-cycle_443369.gr | 

**Description:** A cycle graph on p nodes with chords joining each vertex x to its inverse modulo p. This graph is a (mildly explicit) 3-regular expander. Generated using chordal_cycle_graph function from Python’s networkx package

![](vis/heur_196.png?raw=true)
## heur_197.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
534221 | 738815 | 9799.3 | infrastracture | Open street maps | Mazowsze_Poland.gr | 

**Description:** Mazowsze (Poland): a road network downloaded from open street maps using osmnx Python package

![](vis/heur_197.png?raw=true)
## heur_198.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
878290 | 1023315 | 13737.5 | infrastracture | Open street maps | Ireland.gr | 

**Description:** Ireland: a road network downloaded from open street maps using osmnx Python package

![](vis/heur_198.png?raw=true)
## heur_199.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
1319676 | 1624597 | 22717.9 | infrastracture | Open street maps | Georgia.gr | 

**Description:** Georgia: a road network downloaded from open street maps using osmnx Python package

![](vis/heur_199.png?raw=true)
## heur_200.gr
vertices   | edges   | size (kB) | type | origin | source filename 
 --- | --- | --- | --- | --- | --- | 
1994013 | 2889612 | 42001.5 | infrastracture | Open street maps | Netherlands.gr | 

**Description:** The Nederlands: a road network downloaded from open street maps using osmnx python package

![](vis/heur_200.png?raw=true)
